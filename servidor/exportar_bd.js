...
// Genera un archivo .sql portable
...
// Ruta de mysqldump (ajusta si el MySQL está en otra ubicación)
...
exec(comando, (error, stdout, stderr) => {
  ...
  console.log('');
  console.log('💡 Para importar la BD en otro computador, copia este archivo .sql');
