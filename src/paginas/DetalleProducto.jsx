...
import { PRODUCTOS_DATA, formatearPrecio, renderizarEstrellas, TarjetaProducto } from './Productos';
        ...
        return (
            <>
                <div className="detalle-no-encontrado">
                    ...
                    <Link to="/productos" className="boton-volver">← Volver a productos</Link>
                </div>
            </>
        );
    }

    const productosRelacionados = PRODUCTOS_DATA.filter(p => producto.relacionados.includes(p.id));
                ...
                <div className="detalle-contenido">
                    ...
                    <div className="galeria">
                        ...
                        <div className="galeria-principal">
                            {producto.etiqueta && (
                                <span className={`etiqueta-detalle ${producto.etiqueta.toLowerCase()}`}>
                                    {producto.etiqueta}
                                </span>
                            )}
                    ...
                    <div className="detalle-info">
                        ...
                        <div className="detalle-calificacion">
                            ...
                            <span className="detalle-valoraciones">({producto.valoraciones} reseñas)</span>
                        </div>

                        <div className="detalle-precios">
                            <span className="detalle-precio-actual">{formatearPrecio(producto.precio)}</span>
                            {producto.precioAnterior && (
                                <span className="detalle-precio-anterior">{formatearPrecio(producto.precioAnterior)}</span>
                            )}
                        </div>
                        ...
                        <div className="detalle-accion">
                            ...
                            <button className="boton-carrito-detalle">
                                🛒 Añadir al carrito
                            </button>
                        </div>
                        ...
                        <div className="acordeones">
                            ...
                            <div className="acordeon">
                                ...
                                >
                                    ...
                                    <span className="acordeon-flecha">{acordeonAbierto === 'specs' ? '∧' : '∨'}</span>
                                </button>
                            ...
                            <div className="acordeon">
                                ...
                                >
                                    ...
                                    <span className="acordeon-flecha">{acordeonAbierto === 'envios' ? '∧' : '∨'}</span>
                                </button>
                                {acordeonAbierto === 'envios' && (
                                    <div className="acordeon-contenido">
                                        <p>Envíos a todo Colombia en 3-7 días hábiles. Envío gratis en compras mayores a $200.000.</p>
                                        <p style={{ marginTop: '8px' }}>Devoluciones gratuitas dentro de los primeros 30 días. El producto debe estar en su empaque original sin uso.</p>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="acordeon">
                                ...
                                >
                                    <span>Garantía</span>
                                    <span className="acordeon-flecha">{acordeonAbierto === 'garantia' ? '∧' : '∨'}</span>
                                </button>
                                {acordeonAbierto === 'garantia' && (
                                    <div className="acordeon-contenido">
                                        <p>Este producto cuenta con garantía de fábrica de 12 meses contra defectos de fabricación. Para hacer válida la garantía, conserva tu factura de compra.</p>
                                    </div>
                                )}
                            </div>
                        </div>
                ...
                {productosRelacionados.length > 0 && (
                    <section className="relacionados">
                        <div className="relacionados-cabecera">
                            ...
                            <Link to="/productos" className="ver-mas-link">VER MÁS →</Link>
                        </div>
